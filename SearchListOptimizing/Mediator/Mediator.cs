...
using SearchListOptimizing.ViewModel;
...
namespace SearchListOptimizing.Mediator
{
    ...
    public class Mediator : IMediator
    {
        ...
        static IMediator _instance = new Mediator();
        ...
        public static void SetInstance(IMediator mediatorInstance)
        {
            _instance = mediatorInstance;
        }
        ...
        public void Unregister(object target)
        {
            ...
            invocationList.RemoveActionsForTarget(target);
        }
        ...
        public void NotifyColleagues<T>(string message, T parameter)
        {
            ...
            if (actions != null)
            {
                ...
                {
                    if (action.Target is ViewModelBase && (action.Target as ViewModelBase).IsDisposed)
                    {
                        return;
                    }
