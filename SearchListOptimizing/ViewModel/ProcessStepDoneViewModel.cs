...
{
    public class ProcessStepDoneViewModel : ProcessStepViewModelBase
    {
        ...
        public ProcessStepDoneViewModel(ObservableCollection<CollectionUnitListObject> collectionUnitListObjects)
        {
            var statusList = new List<string> { "22", "27", "29", "31", "32", "33", "34", "35", "36", "37" };
